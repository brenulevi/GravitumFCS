...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_5_Pin|LED_4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BOOT1_Pin SPI2_GP_CS_Pin */
  GPIO_InitStruct.Pin = BOOT1_Pin|SPI2_GP_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_5_Pin LED_4_Pin */
  GPIO_InitStruct.Pin = LED_5_Pin|LED_4_Pin;

...
#define FCU_SPI1_CS_FLASH_GPIO_Port GPIOA
#define FCU_LED_4_Pin GPIO_PIN_12
#define FCU_LED_4_GPIO_Port GPIOB
#define FCU_LED_3_Pin GPIO_PIN_13
#define FCU_LED_3_GPIO_Port GPIOB
#define FCU_LED_2_Pin GPIO_PIN_14
#define FCU_LED_2_GPIO_Port GPIOB
#define FCU_LED_1_Pin GPIO_PIN_15
#define FCU_LED_1_GPIO_Port GPIOB
#define FCU_SDIO_DET_Pin GPIO_PIN_9
#define FCU_SDIO_DET_GPIO_Port GPIOC
